        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-bg min-h-screen p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
                    <div>
                        <h1 class="text-3xl font-bold text-primary"> Add Employee </h1>
                        <p class="text-muted mt-1"> Register a new LGU employee. </p>
                    </div>
                </div>
                ...
                <div class="bg-surface border border-border rounded-xl shadow">
                    <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> <!-- Employee Number -->
                            <div>
                            ...
                            <div>
                                ...
                                <input type="file" name="employee_image"
                                    ...
                                    @error('employee_image') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" name="first_name"
                                    class="mt-2 w-full rounded-lg border border-border px-4 py-3">
                                    @error('first_name') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="middle_name"
                                    class="mt-2 w-full rounded-lg border border-border px-4 py-3">
                                    @error('middle_name') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                            <div>
                                <label> Last Name </label> <input type="text" name="last_name"
                                    class="mt-2 w-full rounded-lg border border-border px-4 py-3">
                                    @error('last_name') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="birth_date"
                                    class="mt-2 w-full rounded-lg border border-border px-4 py-3">
                                    @error('birth_date') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div> 
                            <!-- Contact -->
                            <div>
                                ...
                                <input type="text" name="contact_number" placeholder="09xxxxxxxxx"
                                    class="mt-2 w-full rounded-lg border border-border px-4 py-3">
                                    @error('contact_number') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="contact_person_name"
                                    class="mt-2 w-full rounded-lg border border-border px-4 py-3">
                                    @error('contact_person_name') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="contact_person_number"
                                    class="mt-2 w-full rounded-lg border border-border px-4 py-3">
                                    @error('contact_person_number') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                            <div class="md:col-span-2">
                                ...
                                <textarea name="contact_person_address" rows="3"
                                    ...
                                    @error('contact_person_address') <p class="text-error text-sm mt-1"> {{ $message }} </p>
                                @enderror
                            </div>
                        </div>
