        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-bg min-h-screen p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-muted mt-1">
                            Update the category information for the Local Government Unit.
                        </p>
                    </div>
                ...
                <div class="bg-surface rounded-xl shadow border border-border max-w-3xl">
                    ...
                    <form action="{{ route('categories.update', $categories->id) }}" method="POST" class="p-8">
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="description" rows="5" placeholder="Enter department description..."
                                class="w-full rounded-lg border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 px-4 py-3 outline-none resize-none">{{ old('description', $categories->description) }}</textarea>
