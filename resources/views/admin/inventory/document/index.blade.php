                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-muted mt-1">
                                Manage inventory documents and information.
                            </p>
                        </div>


                        <a href="{{ route('inventory-documents.create') }}"
                        ...
                        <div class="overflow-x-auto">
                            <div class="relative overflow-x-auto bg-white shadow-lg rounded-xl border border-border">
                                ...
                                <div class="p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                                    <form action="{{ route('inventory-documents.index') }}" method="GET">
                                            ...
                                            <div class="p-4 flex flex-col md:flex-row items-center justify-between gap-3">
                                                ...
                                                <div class="relative w-full md:w-96">
                                                    ...
                                                    <input 
                                                        ...
                                                        placeholder="Search inventory documents..."
                                ...
                                <table class="w-full text-sm text-left text-text">
                                    ...
                                    <tbody>
                                        @foreach ($documents as $document)
                                            ...
                                            <tr class=" bg-white border-b border-border hover:bg-green-50 transition cursor-pointer" onclick="window.location='{{ route('inventory-documents.show', $document->id) }}'">
                                                <td class="px-6 py-4">
                                                    {{ $document->document_no }}
                                                </td>
                                                <td class="px-6 py-4">
                                                    {{ $document->accountablePerson->first_name }} {{ $document->accountablePerson->last_name }}
                                                </td>
                                                <td class="px-6 py-4">
                                                ...
                                                <td class="px-6 py-4 text-center">
                                                    {{ $document->receivedFrom->first_name }} {{ $document->receivedFrom->last_name }}
                                                </td>
                                                <td class="px-6 py-4 text-center">
                                                    {{ $document->receivedBy->first_name }} {{ $document->receivedBy->last_name }}
                                                </td>
